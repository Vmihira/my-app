...
export const HeroParallax = ({
  ...
  const translateY = useSpring(useTransform(scrollYProgress, [0, 0.2], [-300, 200]), springConfig)
  return (
    <div
      ref={ref}
      className="h-[250vh] py-10 overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d] bg-gray-900"
    >
      <Header />
      <motion.div
        style={{
...
export const ProductCard = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 h-full w-full opacity-0 group-hover/product:opacity-80 bg-gray-950 pointer-events-none rounded-lg transition-opacity duration-300"></div>
